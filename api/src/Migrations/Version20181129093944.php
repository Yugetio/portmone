 ...
 */
final class Version20181129093944 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE card_entity (id INT NOT NULL, folder_id INT NOT NULL, card_number VARCHAR(255) NOT NULL, cash DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
